...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    media: Schema.Attribute.Media<
      ...
      true
    >;
    approved: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    comments: Schema.Attribute.Relation<'oneToMany', 'api::comment.comment'>;
...
export interface ApiRoomSettingRoomSetting extends Struct.CollectionTypeSchema {
  collectionName: 'room_settings';
  info: {
    singularName: 'room-setting';
    pluralName: 'room-settings';
    displayName: 'room_setting';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::room-setting.room-setting': ApiRoomSettingRoomSetting;
